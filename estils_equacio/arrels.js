...
function creaArrel(entrada) {
    ...
    // S'estableixen les clases de les variables
...
function eliminaArrel(entrada) {
    ...
    // Es fa focus a l'entrada següent de després de l'arrel
    ...
    // S'estableix el valor de l'entrada següent que és el que hi ha davant de l'arrel
